...
public class ModulesSemester_Staff extends AppCompatActivity {
    Button sem1;
    Button sem2;
    Button sem3;
    Button sem4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modules_semester_staff);
        ...
        sem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent sem1 = new Intent(ModulesSemester_Staff.this, ModulesModule_Staff1.class);
                semester = "semester1";
                startActivity(sem1);
            }
        });
