...
public class ModulesModule_Students1 extends AppCompatActivity {
    Button mod1;
    Button mod2;
    Button mod3;
    Button mod4;
    ...
    ModulesSemester_Students modSem;
    public static String module;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_modules_module_students1);
        ...
        modSem = new ModulesSemester_Students();
        ...
        mod1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mod1 = new Intent(ModulesModule_Students1.this, ModulesModuleView1_students.class);
                module = module1;
                startActivity(mod1);
            }
        });
